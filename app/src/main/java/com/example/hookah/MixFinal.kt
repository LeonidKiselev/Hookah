...
class MixFinal : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.mix_final)
        val mixName = intent.getStringExtra("mixName").toString()
        ...
        val tastes =
            this.getSharedPreferences("mix tastes", MODE_PRIVATE).getStringSet(mixName, mutableSetOf())?.joinToString("\n")
